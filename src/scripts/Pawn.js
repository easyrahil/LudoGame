...
export class Pawn extends PIXI.Sprite
{
    constructor(id, textureId, ludoBoard)
    {
        ...
        const widthByHeightRatio = this.width / this.height;
        this.currentWidth = ludoBoard.container.height * 0.08 * widthByHeightRatio;
    ...
    move(pointIndex, bounceEffect= true)
    {
        ...
        return new Promise(resolve => {
            ...
            if(bounceEffect)
            {
                ...
                .to({width: this.currentWidth * 1.3, height : this.currentHeight * 1.3}, 500)
                .yoyo(true)
